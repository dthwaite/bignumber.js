...
!(function() {
    ...
    var errors = {
        ...
        "square root minus one": "Invalid operation - Square root of a negative number"
    };
    ...
    BigNumber.prototype.sqrt=function() {
        if (this.lt(0)) {
            this.number=errors['square root minus one'];
            return this;
        }
        ...
        // Standard, simple iteration to zoom in on the square root by successive approximations
        do {
            last=BigNumber(next);
